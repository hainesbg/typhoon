...
In this tutorial, we'll network boot and provision a Kubernetes v1.17.0-beta.2 cluster on bare-metal with Container Linux.
...
```
# before v1.17.0-beta.2
$ ssh debug@node1.example.com
# after v1.17.0-beta.2
...
node1.example.com   Ready   <none>  10m  v1.17.0-beta.2
node2.example.com   Ready   <none>  10m  v1.17.0-beta.2
node3.example.com   Ready   <none>  10m  v1.17.0-beta.2
```
