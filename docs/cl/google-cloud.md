...
In this tutorial, we'll create a Kubernetes v1.17.0-beta.2 cluster on Google Compute Engine with Container Linux.
...
module "google-cloud-yavin" {
  source = "git::https://github.com/poseidon/typhoon//google-cloud/container-linux/kubernetes?ref=v1.17.0-beta.2"
...
yavin-controller-0.c.example-com.internal  <none>   Ready   6m   v1.17.0-beta.2
yavin-worker-jrbf.c.example-com.internal   <none>   Ready   5m   v1.17.0-beta.2
yavin-worker-mzdm.c.example-com.internal   <none>   Ready   5m   v1.17.0-beta.2
```
