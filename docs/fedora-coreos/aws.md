...
In this tutorial, we'll create a Kubernetes v1.17.0-beta.2 cluster on AWS with Fedora CoreOS.
...
```tf
module "aws-tempest" {
  source = "git::https://github.com/poseidon/typhoon//aws/fedora-coreos/kubernetes?ref=v1.17.0-beta.2"
