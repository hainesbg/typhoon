...
In this tutorial, we'll network boot and provision a Kubernetes v1.17.0-beta.2 cluster on bare-metal with Fedora CoreOS.
...
module "bare-metal-mercury" {
  source = "git::https://github.com/poseidon/typhoon//bare-metal/fedora-coreos/kubernetes?ref=v1.17.0-beta.2"
